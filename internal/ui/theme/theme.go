...
var (
	...
	NavDangerActiveStyle    = NavActiveStyle.Copy().Foreground(lipgloss.Color("203"))
	NavDangerFocusStyle     = NavActiveStyle.Copy().Foreground(lipgloss.Color("203"))
	...
	DangerButtonStyle       = ButtonStyle.Copy().Foreground(lipgloss.Color("203"))
	DangerButtonActiveStyle = ButtonActiveStyle.Copy().Foreground(lipgloss.Color("203"))
	DangerButtonFocusStyle  = ButtonFocusStyle.Copy().Foreground(lipgloss.Color("203"))
